...
This is not a Serpinski triangle. It's wrong. There are lines where there should be triangles.
...
Find where the program draws the triangles and figure out why it isn't drawing correctly.
Look at the code to see if there are any logical flaws like missing or extra semicolons.
...
* 6.c) What is the bug?
There's a semicolon in the wrong place. How serendipitous.
...
No 'I's and the spaces are correct.
...
“double p3x = sideLength -1;” should be “double p3x = sideLength/2.0;”.
...
It would have been difficult. I should have realized it needs a fix around the top vertex.
...
Only half the triangle is showing.
