...
* 1.a) To make a sierpinski triangle
* 1.b) yes it makes a giant rectangle in triangle.html
* 1.c) yes in the main you can specifiy the size of the triangle lines
...
* 2.a) It doesn't show any triangles, and maintains a rectangle shape and the symbols are wrong
...
Set breakpoints to find where the data seems to go wrong is where I'd start.
...
The setup because it doesn't seem to change whats in the grid
...
* 6.c) What is the bug?
i goes up to 40000 and then grid gets assigned a ' '
...
all the f symbols are gone, leaving only white spaces and 8s
...
the j is not used in the print
...
* 11.a) Where is the bug, and how should you fix it?
		Where it finds the top corner of the triangle
* 11.b) If I had not commented my code, how would you have discovered which variable to fix? What if I had used crazy variable names like “fooa, foob, fooc, food, fooe, foof” instead of “p1x, p1y, p2x, p2y, p3x, p3y”?
		I would have had to find what you were doing with those variables
...
* 12.a) What is still wrong with the output?
		It prints on the right half only
...
* 13.a) Which portion of the code do you think is causing the problem? If you aren’t sure, you can try repeating step 4, as well as looking over the code.
		The middle or the left portion
