...
You could set breakpoints after each part of the program to see how the previous part is doing what you told it to do.
...
There is a semi-colon after the for loop statement
